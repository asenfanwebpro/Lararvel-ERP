    ...
    <body class="vertical-layout vertical-menu-modern 1-column blank-page {{ $configData['bodyClass'] }} {{ $configData['theme'] }}" data-menu="vertical-menu-modern" data-col="1-column">
        ...
        <div class="app-content content">
            <div class="content-wrapper">
                <div class="content-body">
                    ...
                    <div id="content">
                        <div class="logo">
                            <img src="{{asset('images/logo/logo-medmar.png')}}">
                        </div>
                        <?php
                        ...
                        <div class="col-md-3 left" id="portdiv" style="min-height:400px">                   
                            @if(isset($data) && count($data)>0)
                                ...
                                <div class="box title" align="left">
                                    ...
                                    <i class="fa fa-tag" style="color:red;margin-left:20px;"></i>
                                    @endif
                                </div>
                                <?php } ?>
                                @endforeach
                        ...
                        <div class="col-md-6 left">
                            <div class="box content" align="center">
                                ...
                                <div id="portcarousel"  class="carousel slide" data-ride="carousel">
                                    ...
                                    <div class="carousel-inner" id="nextdiv" style="padding: 20px; font-size: 18px; margin-top: -10px;">
                                        @foreach($nexthours as $key => $value)
                                        <div class="carousel-item" data-interval="10000">
                                            <div class="tratta" align="center">{{$nextports[$key]}}</div>                                
                                            <div class="time" align="center">{{substr($value,0,5)}}<i style="font-size:35px; font-style:normal;display:block">{{substr($value,5,strlen($value))}}</i></div>
                                        </div>                                        
                                        @endforeach 
                                    </div>                                   
                                    @endif  
                                ...
                                <div id="notecarousel"  class="carousel slide" data-ride="carousel">
                                    ...
                                    @if(isset($nexthours) && count($nexthours)>0)
                                    <div class="carousel-inner" id="notediv" style="padding: 20px; font-size: 18px; margin-top: -10px;">
                                        @foreach($nexthours as $key => $value)                            
                        ...
                        <div class="col-md-3 left">
                            <div class="box" align="center" style="min-height: 210px;padding:20px !important;"> 
                                <div id="myCarousel" class="carousel slide" data-ride="carousel">
                                    
                                    <h3><b style="color:#fff">  {{$today}}</b></h3>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                setInterval(() => {
                    document.location = '../../../monitor/biglietteria/{{$port}}/{{$tag}}';
                }, 300000);
